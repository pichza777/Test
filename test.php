...
<link href='https://fonts.googleapis.com/css?family=Kanit:400,600,400italic&subset=thai,latin' rel='stylesheet' type='text/css'>
...
#bg{ width:100%; }
#vid{ position:absolute; top:0px; padding:30px; color:#FFF; text-shadow:#000 2px 2px; }
</style>
    ...
    <div class="container_12">
      <div class="grid_12">
        <h1 class="logo">
          ...
          <a href="#top"><img src="images/logo.png" alt="">
		  
          </a>
        </h1>
        <nav>
          <ul>
           <li><a href="#services" class="current">ลิงค์ 1</a></li>
           <li><a href="#portfolio">ลิงค์ 2</a></li>
           <li><a href="#about">ลิงค์  3</a></li>
           <li><a href="#contacts">ลิงค์ 4</a></li>
         </ul>
        </nav>
      </div> 
    </div>
  	...
  	<div  class="vid">
  <div class="container_12">
    <video id="bg" src="video/page_bg.webm" height="100%" autoplay="true" loop="true" muted="true"></video>
    <div class="grid_12 ">   
	  ...
	  <br>
      <h4>นึกถึงเสียง นึกถึงเรา<br>
        <span></span>
      </h4> 
      <div class="socials">
        <a href="https://www.facebook.com/950Records" target="_blank" class="fa fa-facebook"></a>
...
<section id="portfolio" class="page page_bg__1">
  <div class="container_12">
    <div class="grid_12">
      <h3 class="head__1">ลิงค์ 2 ใส่รูป</h3>
      <div id="owl" class="gallery">
        <div class="item"><a href="images/nick.jpg" class="gall_item"><img src="images/nick.jpg" alt=""></a></div>
...
<section id="about" class="page">
  <div class="about_inset__1">
    <div class="container_12">
      <div class="grid_12">
        <h3 class="head__1">ลิงค์  3 งานต่างๆ	</h3>
        <div class="story">
          ...
          <div class="cornered pos__1"> <br> Goes On</div>
        </div>
      <div class="clear"></div>
